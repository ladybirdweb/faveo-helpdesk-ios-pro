...
//@discussion After clicking this button it will show status of a ticket.The status can be open,closed, request for close, archieved,resolved.
...
/**
 ...
 @endcode
 */
// This gives list of SLA Plan.
// After clicking this button it will shows list of SLA plans.The SLA plan can be Emergency, High, Low or normal.
- (IBAction)helpTopicClicked:(id)sender;
