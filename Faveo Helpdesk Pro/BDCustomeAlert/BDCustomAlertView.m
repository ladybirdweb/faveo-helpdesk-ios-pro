...
- (void)showAlertWithTitle : (NSString *)title message : (NSString *)message cancelButtonTitle : (NSString *)cancelButtonTitle successButtonTitle : (NSString *)successButtonTitle withSuccessBlock:(void (^)(void))successBlock cancelBlock:(void (^)(void))cancelBlock
{
...
- (void)showAlertWithHeaderImage : (UIImage *)headerImage message : (NSString *)message cancelButtonTitle : (NSString *)cancelButtonTitle successButtonTitle : (NSString *)successButtonTitle withSuccessBlock:(void (^)(void))successBlock cancelBlock:(void (^)(void))cancelBlock
{
    self.alertView.hidden = NO;
    self.toastLabel.hidden = YES;
    successCallBack = successBlock;
...
- (void)showAlertWithHeaderImage : (UIImage *)headerImage message : (NSString *)message cancelButtonTitle : (NSString *)cancelButtonTitle cancelBlock:(void (^)(void))cancelBlock
{
    self.alertView.hidden = NO;
    self.toastLabel.hidden = YES;
    cancelCallBack = cancelBlock;
