                       ...
                       withMenuArray:uniqueStatusNameArray
                          imageArray:uniqueStatusNameArray
                           doneBlock:^(NSInteger selectedIndex) {
                               ...
                               if([self->selectedStatusName isEqualToString:@"Deleted"] || [self->selectedStatusName isEqualToString:@"deleted"])
                               {
                                   [self->utils showAlertWithMessage:NSLocalizedString(@"Ticket is Already Deleted",nil) sendViewController:self];
                                   [[AppDelegate sharedAppdelegate] hideProgressView];
                               }
                               else{
